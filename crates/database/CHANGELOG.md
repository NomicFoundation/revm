...
## [2.0.1](https://github.com/NomicFoundation/revm/compare/revm-database-v2.0.0...revm-database-v2.0.1) - 2025-04-03

### Other

- add 0x prefix to b256! and address! calls ([#2345](https://github.com/NomicFoundation/revm/pull/2345))
- *(database)* remove auto_impl dependency ([#2344](https://github.com/NomicFoundation/revm/pull/2344))
