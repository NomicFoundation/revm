...
## [2.1.0](https://github.com/NomicFoundation/revm/compare/revm-state-v2.0.0...revm-state-v2.1.0) - 2025-04-03

### Added

- Account helper builder functions ([#2355](https://github.com/NomicFoundation/revm/pull/2355))
- support for system calls ([#2350](https://github.com/NomicFoundation/revm/pull/2350))

### Other

- *(state)* Add AccountInfo builder util methods ([#2357](https://github.com/NomicFoundation/revm/pull/2357))
