...
## [21.1.0](https://github.com/NomicFoundation/revm/compare/revm-v21.0.0...revm-v21.1.0) - 2025-04-03

### Added

- support for system calls ([#2350](https://github.com/NomicFoundation/revm/pull/2350))
- Reorder revm deps in Cargo.toml ([#2331](https://github.com/NomicFoundation/revm/pull/2331))
