...
## [2.1.0](https://github.com/NomicFoundation/revm/compare/op-revm-v2.0.0...op-revm-v2.1.0) - 2025-04-03
...
- *(op-tx)* Cover DepositTransactionParts constructor in test ([#2358](https://github.com/NomicFoundation/revm/pull/2358))
